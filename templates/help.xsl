	...
	<html>
		...
		<body>
			<div id="wrap">
				...
				<p>Pokud se při psaní receptu ukáže, že nějaká potřebná surovina neexistuje, nic se neděje: stačí si do nové záložky otevřít přidání nové suroviny a dle potřeby vyplnit; jakmile je surovina v systému, odkaz "aktualizovat" (ve formuláři na úpravu receptu) sesynchronizuje nabídku surovin s databází.</p>
